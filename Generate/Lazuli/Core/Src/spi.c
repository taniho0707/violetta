...
void MX_SPI1_Init(void)
{
  ...
  */
  ...
  /* SPI1_TX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_1, LL_DMAMUX_REQ_SPI1_TX);
  ...
  /* SPI1_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_2, LL_DMAMUX_REQ_SPI1_RX);
...
void MX_SPI2_Init(void)
{
  ...
  */
  ...
  /* SPI2_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_6, LL_DMAMUX_REQ_SPI2_RX);
